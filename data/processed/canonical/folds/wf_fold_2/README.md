# wf_fold_2 per-fold checkpoint

This directory is the destination for the walk-forward fold #2 forecaster
...
To populate:
    ...
    docker compose run --rm backend python -m app.train_forecaster \
        ...
        --fold-id wf_fold_2 \
        --checkpoint-path /data/processed/canonical/folds/wf_fold_2/forecaster_best.pt
