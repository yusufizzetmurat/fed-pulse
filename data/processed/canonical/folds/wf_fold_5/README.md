# wf_fold_5 per-fold checkpoint

This directory is the destination for the walk-forward fold #5 forecaster
...
To populate:
    ...
    docker compose run --rm backend python -m app.train_forecaster \
        ...
        --fold-id wf_fold_5 \
        --checkpoint-path /data/processed/canonical/folds/wf_fold_5/forecaster_best.pt
