...
def test_zero_derived_text_features_masks_multi_task_aux() -> None:
    """The certainty / time masks must all collapse to False (factor +
    topic retired)."""
