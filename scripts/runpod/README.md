...
drivers/   experiment drivers authored on the pod (wave1-4, stage2, salvage, jobs1-3,
...
Embedding caches (data/raw/embeddings/, ~610MB incl voyage @ API cost) are not bundled in this kit — see chat re: whether to ship.
